...
import nextScreen from '../screens/game-2';
import screenBack from '../screens/greeting';

const screenTemplate = getTemplate(`<header class="header">
...
answerContainer.addEventListener(`click`, () => {
  if (answerContainer.querySelectorAll(`.game__answer :checked`).length === 2) {
